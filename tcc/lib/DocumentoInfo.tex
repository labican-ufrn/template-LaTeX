...
\preambulo{Trabalho de conclusão de curso apresentado ao curso de graduação em (Nome do Curso), como parte dos requisitos para obtenção do título de (Título/ em (Curso) da Universidade Federal do Rio Grande do Norte.}
